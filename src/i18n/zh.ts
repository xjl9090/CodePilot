...
const zh: Record<TranslationKey, string> = {
  ...
  // ── Message list ────────────────────────────────────────────
  'messageList.claudeChat': 'xjlPilot 对话',
  'messageList.emptyDescription': '开始与 xjlPilot 对话。提问、获取代码帮助或探索想法。',
  ...
  // ── Settings: General ───────────────────────────────────────
  'settings.title': '设置',
  'settings.description': '管理 xjlPilot 和 Claude Code 设置',
  'settings.overview': '概览',
  'settings.overviewDesc': '一眼看清当前执行引擎 / 服务商 / 模型 / 助理工作空间 / 系统状态，每块只给一个主入口跳转',
  'settings.general': '通用',
  'settings.about': '关于',
  'settings.aboutDesc': 'xjlPilot 版本、平台信息、账户、诊断 / 维护、文档与反馈',
  ...
  'settings.errorReportingDesc': '帮助改进 xjlPilot：匿名上报错误信息，不包含对话内容和 API Key。更改后需重启应用才能完全生效。',
  ...
  'settings.appearanceDesc': '自定义 xjlPilot 的外观和风格',
  // ── Settings: Pet (桌面宠物) ─────────────────────────
  'settings.pet': '桌面宠物',
  'settings.petDesc': '一个随会话状态变化的小窗口，陪你一起工作',
  'pet.master': '显示桌面宠物',
  'pet.masterDesc': '弹出一个常在最上层的小窗口，根据会话状态切换表情',
  'pet.noThemeWarning': '请先在下方新建至少一个主题，再打开宠物开关。',
  'pet.themes': '宠物主题',
  'pet.newTheme': '新建主题',
  'pet.newThemeName': '主题名',
  'pet.newThemeNamePlaceholder': '例如：小龙、像素猫……',
  'pet.uploadFor': '上传"{state}"状态的图片',
  'pet.uploadHint': '只接受 PNG，最大 5MB。建议使用透明背景的图。',
  'pet.create': '创建',
  'pet.cancel': '取消',
  'pet.activate': '使用此主题',
  'pet.activated': '当前使用中',
  'pet.delete': '删除',
  'pet.incomplete': '未完成 — 还需要上传 4 张状态图',
  'pet.stateIdle': '空闲',
  'pet.stateWorking': '工作中',
  'pet.stateWaiting': '等待中',
  'pet.stateDone': '完成',
  'pet.resetPosition': '重置位置',
  'pet.resetPositionDesc': '把宠物窗口移回主屏右下角',
  'pet.empty': '还没有任何主题。点击"新建主题"上传你的第一组 4 张图。',
  ...
  'settings.fontSizeDesc': '整体缩放界面字体（文字、间距、圆角一起按比例调整）',
  ...
  'cli.agentRuntimeDesc': '选择 xjlPilot 执行 Agent 任务的方式',
  'cli.runtimeNative': 'xjlPilot 引擎 (AI SDK)',
  ...
  'provider.emptyDesc': '添加你的第一个 AI 服务，xjlPilot 会自动展示它支持的模型与能力。',
  ...
  'filePreview.external.confirm.body': '确认打开后将以只读模式预览。文件不会自动加载，确认前 xjlPilot 不会读取磁盘内容。',
  ...
  'connection.gitInstallSuccess': 'Git 安装成功！请重启 xjlPilot。',
  ...
  'connection.upgradeSuccess': '升级成功！请重启 xjlPilot 以应用更新。',
  ...
  'update.readyToInstall': 'xjlPilot v{version} 已就绪 — 重启以完成更新',
  'update.installUpdate': '下载并安装',
  'update.later': '稍后',
  'update.rosettaWarning': 'xjlPilot 当前正通过 Rosetta 在这台 Apple Silicon Mac 上运行。安装 arm64 版本可获得更好的响应速度。',
  ...
  'feishu.quickCreateDesc': '自动创建飞书机器人并绑定到 xjlPilot，无需手动配置权限和事件',
  ...
  'tasks.bucketOverdue': '已逾期',
  'tasks.bucketDueSoon': '即将到来',
  'tasks.bucketToday': '今天',
  'tasks.bucketTomorrow': '明天',
  'tasks.bucketThisWeek': '本周',
  'tasks.bucketLater': '之后',
  'tasks.manageAll': '管理全部任务',
  'tasks.openInSettings': '在设置中打开',
  ...
  'mcp.enabled': '已启用',
  'mcp.disabled': '已禁用',
  'mcp.managerDesc': '开关控制 xjlPilot 注入的 MCP 服务。Claude Code 自身配置中的服务仍可能被 SDK 通过 settingSources 自动加载。',
  ...
  'cliTools.viewDocs': '查看 xjlPilot 官方文档',
  ...
  'setup.welcome.description': 'xjlPilot 是多模型 AI Agent 桌面客户端。连接任意 AI 服务商,通过 MCP 和 Skills 扩展能力,让你的助理学会你的工作方式。',
  ...
  'setup.provider.description': '配置 xjlPilot 连接 AI 模型的方式。',
  ...
  'messageInput.placeholderDefault': '让 xjlPilot 做什么…',
  ...
  'mcp.builtin.sectionDescription': 'xjlPilot 自带这些 MCP 能力。是否注入取决于本次消息；这里展示并不代表当前消息已经全部启用。',
