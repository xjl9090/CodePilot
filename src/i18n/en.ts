...
const en = {
  ...
  // ── Message list ────────────────────────────────────────────
  'messageList.claudeChat': 'xjlPilot Chat',
  'messageList.emptyDescription': 'Start a conversation with xjlPilot. Ask questions, get help with code, or explore ideas.',
  ...
  'settings.description': 'Manage xjlPilot and Claude Code settings',
  ...
  'settings.aboutDesc': 'xjlPilot version, platform info, account, diagnostics & maintenance, documentation & feedback',
  'settings.providers': 'Providers',
  'settings.models': 'Models',
  'settings.runtime': 'Runtime',
  'settings.claudeCli': 'Claude Code',
  'settings.codepilot': 'xjlPilot',
  ...
  'settings.errorReportingDesc': 'Help improve xjlPilot by anonymously reporting errors. No conversation content or API keys are included. Restart the app for the change to fully take effect.',
  ...
  'settings.appearanceDesc': 'Customize the look and feel of xjlPilot',
  // ── Settings: Pet (desktop companion) ─────────────────────────
  'settings.pet': 'Pet',
  'settings.petDesc': 'A small companion window that reacts to xjlPilot session state',
  'pet.master': 'Show desktop pet',
  'pet.masterDesc': 'Spawn a small always-on-top window that animates with session state',
  'pet.noThemeWarning': 'Create at least one theme below before enabling the pet.',
  'pet.themes': 'Pet themes',
  'pet.newTheme': 'New theme',
  'pet.newThemeName': 'Theme name',
  'pet.newThemeNamePlaceholder': 'e.g. Dragon, Pixel cat, …',
  'pet.uploadFor': 'Upload image for {state}',
  'pet.uploadHint': 'PNG only, up to 5MB. Transparent backgrounds look best.',
  'pet.create': 'Create',
  'pet.cancel': 'Cancel',
  'pet.activate': 'Use this theme',
  'pet.activated': 'Active',
  'pet.delete': 'Delete',
  'pet.incomplete': 'Incomplete — upload all 4 images',
  'pet.stateIdle': 'Idle',
  'pet.stateWorking': 'Working',
  'pet.stateWaiting': 'Waiting',
  'pet.stateDone': 'Done',
  'pet.resetPosition': 'Reset position',
  'pet.resetPositionDesc': 'Move the pet back to the bottom-right of the primary display',
  'pet.empty': 'No pet themes yet. Click "New theme" to upload your first 4 images.',
  ...
  'settings.fontSizeDesc': 'Scale the entire UI font (typography, spacing, and radii adjust together)',
  ...
  'cli.agentRuntimeDesc': 'Choose how xjlPilot executes agent tasks',
  ...
  'provider.emptyDesc': 'Add your first AI service. xjlPilot will surface its supported models and capabilities automatically.',
  ...
  'filePreview.external.confirm.body': 'Opening it will preview in read-only mode. xjlPilot will not read from disk until you confirm.',
  ...
  'connection.gitInstallSuccess': 'Git installed successfully! Please restart xjlPilot.',
  ...
  'connection.upgradeSuccess': 'Upgrade successful! Please restart xjlPilot to apply the update.',
  ...
  'update.readyToInstall': 'xjlPilot v{version} is ready — restart to update',
  'update.installUpdate': 'Download & Install',
  'update.later': 'Later',
  'update.rosettaWarning': 'xjlPilot is running through Rosetta on this Apple Silicon Mac. Install the arm64 build for better responsiveness.',
  ...
  'feishu.quickCreateDesc': 'Auto-create a Feishu bot and bind it to xjlPilot — no manual permission or event setup needed',
  ...
  'tasks.bucketOverdue': 'Overdue',
  'tasks.bucketDueSoon': 'Due soon',
  'tasks.bucketToday': 'Today',
  'tasks.bucketTomorrow': 'Tomorrow',
  'tasks.bucketThisWeek': 'This week',
  'tasks.bucketLater': 'Later',
  'tasks.manageAll': 'Manage all tasks',
  'tasks.openInSettings': 'Open in settings',
  ...
  'mcp.managerDesc': 'Toggle controls xjlPilot MCP injection. Servers in your Claude Code config may still be loaded by the SDK via its own settings sources.',
  ...
  'cliTools.viewDocs': 'View xjlPilot documentation',
  ...
  // ── Setup Center ──────────────────────────────────────────────
  'setup.title': 'Welcome to xjlPilot',
  ...
  'setup.welcome.description': 'xjlPilot is a multi-model AI agent desktop client. Connect any AI provider, extend with MCP & skills, and let your assistant learn your workflow.',

  // Setup: Claude Code card
  'setup.claude.title': 'Claude Code CLI (Optional)',
  'setup.claude.description': 'Install Claude Code CLI for full command-line capabilities. xjlPilot works without it via the AI SDK engine.',
  ...
  'setup.provider.description': 'Configure how xjlPilot connects to AI models.',
  ...
  'messageInput.placeholderDefault': 'What should xjlPilot do?',
  ...
  'runtimeSelector.codepilotRuntime': 'xjlPilot',
  ...
  'context.unknownCapacityHint': 'This model does not provide a context length. xjlPilot can only count tokens already used.',
  ...
  'runCheckpoint.runtimeFallback.description': 'The selected runtime is unavailable, so xjlPilot will use the available fallback for this message.',
  ...
  'mcp.builtin.sectionDescription': 'xjlPilot includes these MCP capabilities. They are injected only when relevant to the current message; this list does not mean every message has them enabled.',
